...
ADMINS = (
    ('Jason Tsao', 'lanevo6tmegsr@gmail.com'),
)
...
IOS_NOTIFICATIONS_AUTHENTICATION = 'AuthBasic'
IOS_NOTIFICATIONS_PERSIST_NOTIFICATIONS = False
CERTIFICATE = 'J67KYQAW3T'
...
SECRET_KEY = 'jr!r!p4564vy#8yxk=4i!u(5$*g@%x2)7dcv#uk_uuqagp9wo6'
