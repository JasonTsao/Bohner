...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Event.location_coordinates'
        db.delete_column(u'events_event', 'location_coordinates')

        # Adding field 'Event.location_longitude'
        db.add_column(u'events_event', 'location_longitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.location_latitude'
        db.add_column(u'events_event', 'location_latitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Event.location_coordinates'
        db.add_column(u'events_event', 'location_coordinates',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Event.location_longitude'
        db.delete_column(u'events_event', 'location_longitude')

        # Deleting field 'Event.location_latitude'
        db.delete_column(u'events_event', 'location_latitude')
