...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'InvitedFriend.longitude'
        db.delete_column(u'events_invitedfriend', 'longitude')

        # Deleting field 'InvitedFriend.latitude'
        db.delete_column(u'events_invitedfriend', 'latitude')

        # Deleting field 'InvitedFriend.coordinates'
        db.delete_column(u'events_invitedfriend', 'coordinates')

        # Adding field 'InvitedFriend.is_creator'
        db.add_column(u'events_invitedfriend', 'is_creator',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'InvitedFriend.longitude'
        db.add_column(u'events_invitedfriend', 'longitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'InvitedFriend.latitude'
        db.add_column(u'events_invitedfriend', 'latitude',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'InvitedFriend.coordinates'
        db.add_column(u'events_invitedfriend', 'coordinates',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'InvitedFriend.is_creator'
        db.delete_column(u'events_invitedfriend', 'is_creator')
