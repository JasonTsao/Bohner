...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'events_event', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Event.name'
        db.alter_column(u'events_event', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))
