...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventHistorical'
        db.create_table(u'events_eventhistorical', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent_event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Event'])),
            ...
            ('event_type', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ...
        db.send_create_signal(u'events', ['EventHistorical'])


    def backwards(self, orm):
        # Deleting model 'EventHistorical'
        db.delete_table(u'events_eventhistorical')
