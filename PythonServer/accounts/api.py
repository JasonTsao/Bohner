...
def facebookConnect(request):
	...
	return HttpResponseRedirect(REQUEST_TOKEN_URL + '?client_id=%s&redirect_uri=%s&scope=%s' % (APP_ID, callback_url,'email,read_friendlists, user_photos, user_birthday, user_events, user_groups'))
