...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VenmoTransaction'
        db.create_table(u'accounts_venmotransaction', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('charger', self.gf('django.db.models.fields.related.ForeignKey')(related_name='charger', to=orm['accounts.VenmoProfile'])),
            ('charged', self.gf('django.db.models.fields.related.ForeignKey')(related_name='charged', to=orm['accounts.VenmoProfile'])),
            ('payment_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.send_create_signal(u'accounts', ['VenmoTransaction'])


    def backwards(self, orm):
        # Deleting model 'VenmoTransaction'
        db.delete_table(u'accounts_venmotransaction')
