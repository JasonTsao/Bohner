...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AccountSettings.allow_charge'
        db.add_column(u'accounts_accountsettings', 'allow_charge',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AccountSettings.allow_charge'
        db.delete_column(u'accounts_accountsettings', 'allow_charge')
