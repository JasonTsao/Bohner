...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Account.profile_pic'
        db.alter_column(u'accounts_account', 'profile_pic', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Account.profile_pic'
        db.alter_column(u'accounts_account', 'profile_pic', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
