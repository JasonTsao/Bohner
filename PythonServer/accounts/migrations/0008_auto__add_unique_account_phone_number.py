...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Account', fields ['phone_number']
        db.create_unique(u'accounts_account', ['phone_number'])


    def backwards(self, orm):
        # Removing unique constraint on 'Account', fields ['phone_number']
        db.delete_unique(u'accounts_account', ['phone_number'])
