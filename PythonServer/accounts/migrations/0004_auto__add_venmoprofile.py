...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VenmoProfile'
        db.create_table(u'accounts_venmoprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Account'])),
            ('venmo_id', self.gf('django.db.models.fields.CharField')(max_length=150)),
        ...
        db.send_create_signal(u'accounts', ['VenmoProfile'])


    def backwards(self, orm):
        # Deleting model 'VenmoProfile'
        db.delete_table(u'accounts_venmoprofile')
